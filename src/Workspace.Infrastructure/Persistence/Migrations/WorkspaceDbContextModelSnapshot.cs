...
internal static class M1Model
{
    public static void Build(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity("Workspace.Infrastructure.Persistence.WorkspaceState", b => { b.Property<int>("Id").ValueGeneratedOnAdd().HasColumnType("integer"); b.Property<long>("Version").HasColumnType("bigint"); b.HasKey("Id"); b.ToTable("workspace_state"); });
